...
export async function addWatchFolder(path: string) {
  return invokeTyped<void>('add_watch_folder', { path })
}

export async function removeWatchFolder(path: string) {
  return invokeTyped<void>('remove_watch_folder', { path })
}

export async function listWatchFolders() {
  return invokeTyped<string[]>('list_watch_folders')
}