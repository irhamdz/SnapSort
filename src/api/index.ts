...
export async function searchScreenshots(filters: SearchFilters) {
  return invokeTyped<Screenshot[]>('search_screenshots', {
    query: filters.query,
    start_date: filters.start_date,
    end_date: filters.end_date,
    category: filters.category,
    tag: filters.tag,
    app_detected: filters.app_detected,
    limit: filters.limit,
